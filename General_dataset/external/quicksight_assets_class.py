class Analysis():
	def __init__(self, aws_account_id, analysis_id, analysis_name):
		...
		# The ID for the analysis that we're creating. This ID displays in the URL of the analysis
		self.analysis_id = analysis_id

		# A descriptive name for the analysis that we're creating
		...
		# a source entity to use for the analysis that we're creating. 
		...
		# The ARN for the theme to apply to the analysis that we're creating.
		self.theme_arn = ""
