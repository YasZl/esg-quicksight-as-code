...
def build_esg_analysis(
    ...
    # Filtre score minimum sur COMPOSITE_INDEX (via mappings)
    #score_min_filter = create_score_min_filter(
    #   "score_min_filter_1",
    #  mappings["emissions_total"],  # chez toi c'est COMPOSITE_INDEX
    #    dataset_id
    #)
    ...
    # Retourne la structure complète (dict JSON-compatible)
