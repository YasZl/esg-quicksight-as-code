...
def build_overview_sheet(dataset_id, mappings):
    ...
    # Bar Chart (Emissions by Sector) (Top Center)
    ...
    # Pie Chart (Sector Composition) (Top Right)
    ...
    sheet = add_visual_to_sheet(sheet, table_vis, row=12, col=0, row_span=10, col_span=30)
